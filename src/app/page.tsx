    ...
    <main className="bg-white">
      ...
      <section className="relative h-[85vh] flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 flex flex-col items-center">
          ...
          <Link
            href="/menu"
            className="bg-brand-red px-12 py-4 rounded-2xl font-extrabold text-lg hover:bg-red-800 transition-all hover:scale-105 inline-block shadow-xl"
          >
            VER MENÚ
          </Link>
        </div>
      ...
      <section className="py-20 bg-red-800">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-black mb-10 text-amber-300 flex items-center gap-4">
            NUESTRAS PROMOS
        ...
        <div className="flex overflow-x-auto pb-12 px-6 gap-6 no-scrollbar snap-x">
          {PROMOCIONES.map((promo) => (
            <div
              key={promo.id}
              className="group relative flex-none w-80 h-64 rounded-2xl overflow-hidden snap-center shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-brand-yellow"
            >
              {/* 1. LA FOTO CON ZOOM */}
              <div
              ...
              <div className="absolute inset-0 bg-linear-to-b from-black/90 via-black/40 to-transparent" />
